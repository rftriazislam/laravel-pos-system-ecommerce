            ...
            <div class="card-body p-0">
                ...
                <form class="p-4" action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group p-1 row">
                        ...
                        <div class="col-md-9">
                            <select class="select2 form-control select2 form-select" name="parent_id" data-toggle="select2" data-placeholder="Choose ..."data-live-search="true" data-selected="{{ $category->parent_id }}">
                    ...
                    <div class="form-group p-1 row">
                        ...
                        <div class="col-md-9">
                            <select name="digital" required class="form-control select2 form-select mb-2 mb-md-0">
                    ...
                    @endif
                    <div class="form-group p-1 mb-0 d-flex justify-content-end">
