...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="align-items-center"><h1 class="h3">{{translate('All Customers')}}</h1></div>
</div>
...
<div class="card">
    <form class="" id="sort_customers" action="" method="GET">
        <div class="card-header row gutters-5">
            ...
            <div class="col-md-2">
                <div class="form-group mb-0">
                    <a class="btn btn-primary" href="">Add New Customer</a>
                </div>
            </div>
        </div>
                        ...
                        @if ($customer->user != null)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    {{-- <a href="{{route('customers.edit', encrypt($customer->id))}}" class="btn btn-soft-primary btn-icon btn-circle btn-sm" title="{{ translate('Log in as this Customer') }}">
                                        <i class="las la-edit"></i>
                                    </a> --}}
