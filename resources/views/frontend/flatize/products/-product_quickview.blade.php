<style type="text/css">
    ...
    .quick-view-index-img { width: 61px; height: 92px; }
</style>
                    ...
                    <div class="col-sm-6">
                        <div class="product-preview">
                            <ul class="bxslider" id="slider1">
                                @if ($product_info['images'])
                                    @foreach ($product_info['images'] as $image)
                                        <li><img alt="" class="img-responsive quick-view-img" src="{{ asset('public/'.$image->file_name) }}"></li>
                                    @endforeach
                                @endif
                            </ul>
                            ...
                            {{-- <ul class="list-inline bx-pager">
                                @if ($product_info['images'])
                                    @foreach ($product_info['images'] as $image)
                                        <li><a data-slide-index="0" href=""><img alt="" class="img-responsive quick-view-index-img" src="{{ asset('public/'.$image->file_name) }}"></a></li>
                                    @endforeach
                                @endif
                            </ul> --}}
                        </div>
