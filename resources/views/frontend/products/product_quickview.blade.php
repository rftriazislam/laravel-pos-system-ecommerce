                            ...
                            <div class="col-sm-6">
                                <div class="product-preview">
                                    <ul class="bxslider" id="slider1">
                                        <li><img alt="" class="img-responsive" src="{{ asset('public/frontend/flatize/images/content/products/product-1.jpg') }}"></li>
                                        <li><img alt="" class="img-responsive" src="{{ asset('public/frontend/flatize/images/content/products/product-1-1.jpg') }}"></li>
                                        <li><img alt="" class="img-responsive" src="{{ asset('public/frontend/flatize/images/content/products/product-1-2.jpg') }}"></li>
                                        <li><img alt="" class="img-responsive" src="{{ asset('public/frontend/flatize/images/content/products/product-1-3.jpg') }}"></li>
                                        <li><img alt="" class="img-responsive" src="{{ asset('public/frontend/flatize/images/content/products/product-1-4.jpg') }}"></li>
                                    </ul>

                                    <ul class="list-inline bx-pager">
                                        <li><a data-slide-index="0" href=""><img alt="" class="img-responsive" src="{{ asset('public/frontend/flatize/images/content/products/product-thumb.jpg') }}"></a></li>
                                        <li><a data-slide-index="1" href=""><img alt="" class="img-responsive" src="{{ asset('public/frontend/flatize/images/content/products/product-thumb-1.jpg') }}"></a></li>
                                        <li><a data-slide-index="2" href=""><img alt="" class="img-responsive" src="{{ asset('public/frontend/flatize/images/content/products/product-thumb-2.jpg') }}"></a></li>
                                        <li><a data-slide-index="3" href=""><img alt="" class="img-responsive" src="{{ asset('public/frontend/flatize/images/content/products/product-thumb-3.jpg') }}"></a></li>
                                        <li><a data-slide-index="4" href=""><img alt="" class="img-responsive" src="{{ asset('public/frontend/flatize/images/content/products/product-thumb-4.jpg') }}"></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="summary entry-summary">
                                    ...
                                    <p class="price">
                                        <span class="amount">৳ {{ $product_info['unit_price'] }}</span>
                                    </p>
